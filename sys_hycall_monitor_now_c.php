...
<body style="font-family:K2D;font-size:18px;">
    <div class="container-fluid" style="margin: 2px 2px 2px;padding: 2px 2px 2px;">
        <div class="justify-content-md-center">
            <table id="dataTable-q" class="display dataTable" 
            style="width:100%;box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px; 
                           ...
                           font-family:K2D;font-size:18px;" cellspacing="0">
                <thead
                ...
                <tbody>
                    ...
                    FROM v_rf_detail 
                    WHERE rf_hospital='$hcode' AND end_refer_end='N' AND rfgroup='2' Order by rf_id DESC";
                    ...
                    <tr style="<?php echo $bc; ?>">
                        ...
                        <td>
                            ...
                            if($rs['rf_status']=='1' || $rs['rf_status'] =='0'){
                                echo '<a href="#myModal_approve_mob" data-toggle="modal" data-id="'.$rs['rf_id'].'">
...
<script type="text/javascript">
$(document).ready(function() {
    $('#myModal_approve_mob').on('show.bs.modal', function(e) {
...
<div class="modal fade" id="myModal_approve_mob" role="dialog">
