                        ...
                        <div class="card-body"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-1">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="optradio">ผ่าน
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input"
                                                name="optradio">ไม่ผ่าน/ปรับปรุง
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-5">
