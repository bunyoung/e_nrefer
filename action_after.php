...
$dcd=SUBSTR($_POST['dc'],0,2);
$dcm=SUBSTR($_POST['dc'],3,2);
$dcy=SUBSTR($_POST['dc'],6,4)-543;
$dch=$dcd.$dcm.$dcy;
...
{ 
    ...
    if($pt=='1')
    {
        ...
        TO_CHAR(O.OPD_DATE,'DDMMYYYY') ='$dch' AND 
    ...
    { 
         ...
         FROM IPDTRANS I
         INNER JOIN V_PATIENTS VP ON VP.HN=I.HN AND TO_CHAR(I.DATEDISCH,'DDMMYYYY') ='$dch' AND 
