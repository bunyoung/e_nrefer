...
$hyass=@$_POST['hyass'];
$hcolor=@$_POST['hycolor'];
IF(@$_POST['faststatus']=='1'){$faststatus=1;}else{$faststatus=0;}

$sql_add = " INSERT INTO fast_sick_a (
fasts_name,fasts_color,hyass,fasts_status)
VALUES ('$fastname','$hcolor','$hyass','$faststatus');";
$result_sql_add = mysqli_query($conn,$sql_add);

if ($result_sql_add== FALSE) {
    $error1 = ' UPDATE ERROR ';
...
$sql_edit = "UPDATE fast_sick_a
SET
fasts_name='$fastname',
fasts_status='$faststatus'
WHERE fasts_id='$hid' ; ";
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                <header>
                                    ...
                                    <h5> : ฟอร์มข้อมูล ด่วนหัตถการ
                                    </h5>
                                </header>
                                <p>
                                <form class="form-horizontal" action="sys_admin_fasta_add.php" method=POST target="">
                                    <div class="form-group">
                                        <label for="idsend" class="col-lg-2 col-form-label" align="right">ประเภท ผป : </label>
                                        <div class="col-lg-6">
                                           <?php 
                                    ...
                                    <div class="form-group">
                                        <label for="fullplace" class="control-label col-lg-2" align="right">รายการ :
                                        </label>
                                        <div class="col-lg-4">
                                            <input type="text" id="fastname" name="fastname" placeholder="ด่วนหัตถการ"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                           <?php 
                                                $SQLcolor = mysqli_query($conn,"SELECT fasts_color FROM fast_sick_a GROUP BY fasts_color ORDER BY fasts_color") 
                                                    OR die(mysqli_error());
                                            ?>
                                            <div class="col-lg-8">
                                                <select class="form-control" name="hcolor" id="sel_hyass">
                                                    <option value="" selected disabled>(เลือกรายการที่ต้องการ)</option>
                                                    <?php
                                                    while($row=mysqli_fetch_array($SQLcolor))
                                                    {
                                                    ?>
                                                    <option value="<?php echo $row['fasts_color'];?>">
                                                            <?php echo $row['fasts_color'];?>
                                                    </option>
                                                    <?php
                                                    }
                                                    ?>
                            ...
                            <div class="box">
                                <header>
                                    ...
                                    <h5>แก้ไขรายการข้อมูล ด่วนหัตถการ
                                    </h5>
                                </header>
                                <p>
                                    <?php
...
?>
                                        <tr>
                                            ...
                                            <td>
                                                <center><?php  echo $rs_deb['fasts_id']; ?> </center>
                                            </td>
                                            <td>
                                                <center><?php  echo $rs_deb['fasts_name']; ?> </center>
                                            </td>
                                            <td>
                                                <center>
                                                    <?php IF($rs_deb['fasts_status']==0){
                                                           echo'<a href="#myModal_type_fasta" data-toggle="modal" data-id="'.$rs_deb['fasts_id'].'" class="btn btn-success btn-xs btn-grad">';
                                                          }ELSE{
                                                            echo'<a href="#myModal_type_fasta" data-toggle="modal" data-id="'.$rs_deb['fasts_id'].'" class="btn btn-danger btn-xs btn-grad">';}
                                                          IF($rs_deb['fasts_status']==0){
...
$(document).ready(function() {
    $('#myModal_type_fasta').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            type: 'post',
            url: 'sys_admin_fasta_edit.php', //Here you will fetch records
            data: {
                'hid': hid
            }, //Pass $id
