...
if(@$_POST['ADD'])
{
    ...
    else
    {
        ...
        build,
        class)
        VALUES ('$placecode','$fullplace','$opdipd','$fl','$build','$class');";
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <form class="form-horizontal" action="sys_admin_type_place_add.php" method=POST
                                    ...
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="fullplace" class="control-label col-lg-2">ประเภท OPD/IPD
                                        </label>
                                        <div class="col-lg-4">
                                            <select name="opdipd">
                                    ...
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="fullplace" class="control-label col-lg-2">สายตามโลจิสติกส์
                                        </label>
                                        <div class="col-lg-4">
                                            <select class="form-control" name="floor">
                                                <option value="F1">สายที่ 1</option>
                                                <option value="F2">สายที่ 2</option>
                                                <option value="F3">สายที่ 3</option>
                                                <option value="F4">สายที่ 4</option>
                                                <option value="F5">สายที่ 5</option>
                                                <option value="F6">สายที่ 6</option>
                                                <option value="F7">สายที่ 7</option>
                                                <option value="F8">สายที่ 8</option>
                                                <option value="F9">สายที่ 9</option>
                                                <option value="F10">สายที่ 10</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php    echo $rs_deb['floor']; ?>
                                            </td>
                                            <td>
                                                <?php    echo $rs_deb['opdipd']; ?>
                                            </td>
                                            <td>
                                                <?php    echo $rs_deb['name']; ?>
                                            </td>
                                            <td>
                                                <?php    echo $rs_deb['class']; ?>
                                            </td>
                                            <td>
                                                <center>
...
$(document).ready(function() {
    $('#myModal_type_place').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            type: 'post',
            url: 'sys_admin_logis_place_edit.php', //Here you will fetch records
            data: {
                'hid': hid
            }, //Pass $id
