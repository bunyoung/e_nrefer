                ...
                <tr>
                    <table width="100%" align="center" style='border: 0px solid; padding-left:60px;
                        ...
                        <tr>
                            ...
                            <td
                                style="font-family:sarabun; font-size: 18px; font-weight:bold;padding: 2rem; text-align:center;">
                                แบบบันทึกการรับ-ส่งต่อผู้ป่วยโรงพยาบาล ในสังกัดกระทรวงสาะารณสุข</td>
                            <td width="10%"><img src="img/hy.png" style="width:60px;height:60px;"></td>
                        </tr>
                        <tr>
                            <td colspan="6"
                                style="font-family:sarabun; font-size: 16px; font-weight:bold;padding: 2rem; text-align:center;">
                                <?php echo $h1; ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="6">
                                ชื่อ-สกุล ผู้ป่วย <?php echo $h5;?> อายุ <?php echo $h6;?> ปี
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
