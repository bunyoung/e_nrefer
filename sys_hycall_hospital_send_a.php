...
<div class="container-fluid" style="margin: 2px 2px 2px;padding: 2px 2px 2px;color:black;">
        <div class="commenta justify-content-md-center">
            <table id="dataTable-x" class="display dataTable" role="grid" style="width:100%;box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px; 
                ...
                style="font-family: sarabun;font-size:normal;margin-top:0px;background-color:#472183;color:#F1F8E9">
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <center><i class='fa fa-print fa-2x' style='color:#FFF'></i></center>
                        </td>
                        <td><i class="fa fa-hotel" style="font-size:40px;color:#FFF"></i></td>
                    </tr>
                </thead>
                ...
                * 
                FROM v_rf_detail 
                WHERE hosp_recive_rem='1'  AND rf_hospital = '$hcode'  AND  end_refer_end='N' Order by rf_id DESC";
