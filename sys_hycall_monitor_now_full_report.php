...
<body style="font-family:K2D;font-size:18px;">
    <div class="container">
        <p>
        <!-- <div class="outer"> -->
            <div class="inner bg-light lter"   style = "background-color:#4EC5F1;padding:70px 20px 80px 50px;">
                <br>
                <div class="row-fluid">
                    <div class="span4">
                        <!-- <div class="alert alert-success"> -->
                            <form class="form-inline" action="sys_hycall_now_full_real.php" name="ins_fund_main"
