...
<body style="font-family: K2D;font-size:17px;">
    <div class="container-fluid" style="margin: 2px 2px 2px;padding: 2px 2px 2px;">
        <div class="commenta justify-content-md-center">
            <table id="dataTable-z" class="display dataTable" role="grid" style="width:100%;box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px; 
                ...
                <tbody>
                    ...
                    <?php
                $i=0;
                $sql="SELECT * FROM v_rf_detail  WHERE rf_hos_send_to = '$hcode' AND 
                            end_refer_end='N' AND 
                            rf_no_thairefer <> '' AND 
                            rf_ptype_expire<>'' AND 
                            rf_place_money<>'' AND 
                            rf_pttype<>'' AND
                            hosp_recive_status='Y'  
