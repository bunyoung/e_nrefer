...
<p>
<form class="form-horizontal" action="sys_hycall_center_asset_nowb.php" method=POST target="">
    ...
    <div class="form-group">
        <label for="name" class="control-label col-md-3">เหตุผลให้คำปรึกษา </label>
        <div class="col-md-3">
