        ...
        <div class="col-md-11" style="font-family: 'sarabun'; margin-top:0px;background-color:#F2F4F4">
            <div class="table-responsive-sm">
                ...
                <table class="table table-bordered" id="example">
                    ...
                    if($did<>null)
                    {
                        ...
                        WHERE rf_date between '$d_start' AND '$d_end' AND 
                                    m_doctor = '$did'  AND rf_rfev ='2' AND 
                                    rf_hospital='$hcode'   AND
                                    rf_no_refer is null
                        Order by rf_id DESC";
				}else{
                        $sql="
				...
				while($rs=mysqli_fetch_array($query)) {
                    ...
                    ?>
                        <?php
                    if($rs['rf_rfev']=='1') {?> <tr style="backgrond-color:#A2D9CE;color:#D5F5E3;font-weight:400;"> <?php }
                    if($rs['rf_no_refer']<>'') {?>
                        <tr style="background-color:#F5CBA7;color:#145A32;font-weight:400;"><?php }
                    if($rs['hosp_recive_status']=='Y' && $rs['hosp_recive_rem']=='1') {?>
                        <tr style="background-color:#E9F7EF;color:#145A32;font-weight:400;"><?php 
                    }else{
                        if($rs['hosp_recive_status']=='Y' && $rs['hosp_recive_rem']=='2') {?>
                        <tr style="background-color:#FAE5D3;color:#145A32;font-weight:400;"><?php 
                        }
                    }
                    ?>
