...
<body onLoad="window.print();">
    <?php
	    $result= mysqli_query($conn,"select * from v_asmonitor_c where hyitem='$htem' ") 
                 or die (mysqli_error());
...
<div id="header">
    ...
    <div class="container">
        <hr>
        <center>
            <h4 style="margin-top:-14px;">ใบมอบหมายงานเคลื่อนย้ายเวชภัณฑ์และสิ่งของ</h4>
        </center>
        <table class="styled-table" style="font-size:13px;">
            <tr>
                <th>ประเภท</th>
                <td>เวชภัณฑ์และสิ่งของ</td>
            </tr>
            <tr>
                <th>เตรียมรับ</th>
            ...
            <tr>
                <th></th>
                <td>เจ้าหน้าที่ต้นทาง (<?php echo $row['ftplace'];?>)</td>
            </tr>
            <tr>
                <th></th>
                <td></td>
