        ...
        <div class="exTab">
            <ul class="nav nav-tabs" style="color:#330066;font-weight: bold;margin-top:-18px;">
                <li class="active">
                    <a data-toggle="tab" href="#home">
                        ...
                        </i> ขนส่งผลิตภัณฑ์เลือดจากธนาคารเลือด
                    </a>
                </li>
                <li>
                    <a data-toggle="tab" href="#menu1">
                        <i class="fa fa-ambulance fa-lg" aria-hidden="true" style="color:yellow;">
                        </i> ศูนย์เครื่องมือแพทย์
                    </a>
                </li>
                <li>
                    <a data-toggle="tab" href="#menu2">
                        <i class="fa fa-truck fa-lg" aria-hidden="true"
                            style="color:red;font-size: 1.2em;font-weight: bold;"></i>
                        เวชภัณฑ์และสิ่งของต่างๆ
                    </a>
                </li>
                <li>
                    <a data-toggle="tab" href="#menu3">
                        <i class="fa fa-eraser fa-lg" aria-hidden="true"
                            style="color:green;font-size: 1.2em;font-weight: bold;"></i>
                        ขอใช้บริการทำความสะอาด
                    </a>
                </li>
            </ul>
            ...
            <div class="tab-content">
                <div id="home" class="tab-pane fade in active">
                    ...
                    <div id="content3" style="margin-top:-18px;">
                ...
                <div id="menu2" class="tab-pane fade">
                    <div id="content3" style="margin-top:-18px;">
                        <div class="inner bg-light lter">
                            <?php include('sys_hycall_center_asset_nowc.php'); ?>
                        </div>
                    </div>
                </div>
                <div id="menu3" class="tab-pane fade">
                    ...
                    <div id="content3" style="margin-top:-18px;">
                        <div class="inner bg-light lter">
                            <?php include('sys_hycall_center_asset_nowd.php'); ?>
                        </div>
                    </div>
                    <!-- </div> -->
                </div>
...
<ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#home">
            <i class="fa fa-fw fa-bell-o"></i>ขนส่งผลิตภัณฑ์เลือดจากธนาคารเลือด</a></li>
    ...
    <li><a data-toggle="tab" href="#menu3">บริการทำความสะอาดและผลิตภัณฑ์อื่น ๆ</a></li>
</ul>

<div class="tab-content">
    <div id="home" class="tab-pane fade in active">
        <div class="panel-group">
            <?php include ('sys_hycall_center_call_finish_now.php'); ?>
        </div>
    </div>
    <div id="menu1" class="tab-pane fade">
        <div class="panel-group">
            <!-- งานจบภาระกิจ  -->
            <?php include ('sys_hycall_center_call_employee_now.php'); ?>
        </div>
    </div>
    <div id="menu2" class="tab-pane fade">
        <div class="panel-group">
