        ...
        <div class="panel-body" style="background:#90caf9; color:#354649;font-weight: bold;font-size: 1.1em;">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2" name="fan" id="fan">
                        <option value="" selected disabled>(เลือกรายการ)</option>
                        <?php 
                        $strSQL2="SELECT an,flname FROM ipdtrans where datedisch IS  NULL
                                  AND pla_placecode not in('TEST')
                        ...
                        { 
                        ?>
                        <option value="<?=$objResult2["AN"];?>">
                            <?=$objResult2["AN"]." - ".$objResult2["FLNAME"];?>
                        </option>
                        <?php
                        }                                                                  
                        ?>
                ...
                <div class="form-group col-sm-1">
                    ...
                    <input type="text" disabled class="form-control" name="sex" id="sex">
                </div>
                <div class="form-group col-sm-1">
                ...
                <div class="form-group col-sm-2">
                    ...
                    <input type="text" disabled class="form-control" name="date_admit" id="date_admit">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-sm-2">
                    ...
                    <input type="text" disabled class="form-control" name="hn" id="hn">
                </div>
                <div class="form-group col-sm-4">
                    <label for="flname">ชื่อ นามสกุล</label>
                    <input type="text" disabled class="form-control" name="n_flname" id="n_flname">
                </div>
                <div class="form-group col-sm-3">
                    <label for="ptype">สิทธิ์การรักษา</label>
                    <input type="hidden" class="form-control" name="pt_type" id="pt_type">
                    <input type="text" disabled class="form-control" name="n_pt_type" id="n_pt_type">
                </div>
                <div class="form-group col-sm-3">
                    <label for="bed">เตียง</label>
                    <input type="text" disabled class="form-control" name="beds" id="beds">
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input class="form-control" name="h_arti_id" type="hidden" id="h_arti_id" value="" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        color:#354649;font-weight: bold;font-size: 1.1em;">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label for="pcr">จุดประสงค์ในการปรึกษาครั้งนี้</label>
                                    <textarea class="form-control" name="mo-ftext" id="mo-ftext"
                                              rows="3">
                                    </textarea>
                                    <br>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label for="oth">การวินิจฉัยโรค (Free text)</label>
                                            <textarea class="form-control" name="exp" id="mo-exp"
                                                rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
