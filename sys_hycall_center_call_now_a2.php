...
$SQLhst = mysqli_query($conn,"SELECT id,hostype
FROM sys_hostype ORDER BY hostype") OR die(mysqli_error());
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default" style="margin-left:-15px;">
                <div class="panel-heading" style="background:#663399;opacity: 1;
                         color:	#FFFFFF;font-size: 1.2em;font-weight: bold;">
                    <span class="glyphicon glyphicon-send"></span>
                    ขอใช้บริการขนส่งเครื่องมือแพทย์จากศูนย์เครื่องมือแพทย์ OPD/IPD
                </div>
                <div class="panel-body" style="background:#6699FF;opacity: 0.90;
                        color:#462066;font-weight: bold;font-size: 1.1em;">
                    <form class="form-horizontal" action="sys_hycurr_db.php" method="POST" target="" name="" id="">
                        ...
                        <div class="panel-body">
                            ...
                            <!-- เพิ่มเติมชนิดเครื่องมือแพทย์ -->
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-sm-4" for="typehos">ระบุ ชนิดเครื่องมือแพทย์</label>
                                    <div class="col-sm-6">
                                        <select class="form-control select2" style="width:100%;" name="typehos">
                                            <option value="" selected disabled>(เลือกรายการ)</option>
                                            <?php
                                        while($row1=mysqli_fetch_array($SQLhst))
                                        {
                                        ?>
                                            <option value="<?php echo $row1['id'];?>">
                                                <?php echo '['.$row1['id'].']'.'  '.$row1['hostype'];?>
                                            </option>
                                            <?php
                                        }
                                        ?>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="DADE" value="DADE">
