...
<body  style="font-family:K2D;font-size:18px;">
    <div class="container-fluid" style="margin: 2px 2px 2px;padding: 2px 2px 2px;">
        <div class="commenta justify-content-md-center">
            <table id="dataTablef" class="display dataTable" role="grid"
        ...
        FROM v_rf_detail 
                    WHERE rf_hospital='$hcode' AND end_refer_end='N' AND rfgroup='3' Order by rf_id DESC";
                    ...
                    <tr style="<?php echo $bc; ?>">
                        ...
                        <td>
                            ...
                            if($rs['rf_status']=='1' || $rs['rf_status'] =='0'){
                                echo '<a href="#myModal_approve_mod" data-toggle="modal" data-id="'.$rs['rf_id'].'">
...
<script type="text/javascript">
$(document).ready(function() {
    $('#myModal_approve_mod').on('show.bs.modal', function(e) {
...
<div class="modal fade" id="myModal_approve_mod" role="dialog">
