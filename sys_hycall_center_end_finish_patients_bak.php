...
$frmplace = $rsd['fromplace'];
$toplace = $rsd['toplace'];
$fplace=$rsd['fplace'];   // หน่วยร้องขอ
$tplace=$rsd['tplace'];   // หน่วยร้องขอ
$hdate = $d_default;
      ...
      <span>
        <div class="box primary">
          <header>
            ...
            <h5>&nbsp;เรียกบริการศูนย์เปล วันที่ปัจจุบัน &nbsp; <a class="text text-danger"><strong>
            <?php echo $d_default; ?>:
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            <label for="shn" class="control-label col-lg-2"> HN : </label>
              ...
              <label for="shn" class="control-label col-lg-3">ชื่อ-สกุล :</label>
              <div class="col-lg-4">
                <input type="hidden" name="nname" id="nname" value="<?php echo $na; ?>">
                  <input type="text" class="form-control" id="nname" value="<?php echo $na; ?>" readonly required>
                </div>
              </div>
             ...
             <div class="form-group">
               ...
               <div class="col-lg-5">
                 ...
                 <option value=""><?php echo '['.$hyass.']'.' '.$hyname; ?></option>
                 <?php
              ...
              <div class="form-group">
                  ...
                  <?php
                     while($row1=mysqli_fetch_array($SQLfast))
                     {
                     ?>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-5">
                  <select class="form-control" name="bidhass">
                    <option value=""><?php echo '['.$hassa.']'.' '.$hassnamea; ?></option>
                    <?php
                ...
                <div class="form-group">
                   ...
                   <div class="col-lg-5">
                     <select class="form-control input-sm select2" name="toplace">
                       <option value=""><?php echo '['.$frmplace.']'.' '.$fplace; ?></option>
                       <?php
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="fplace" value="<?php echo $toplace; ?>">
