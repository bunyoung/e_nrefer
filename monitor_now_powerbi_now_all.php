...
VP.PRO1_PROV_CODE,
 ...
 I.OWNNAME,DECODE(REFERTYPE,'1','Refer จาก รพ. ','2','Refer ไป รพ. ')  REFERTYPE,HOS_IN_CARD,(SELECT OFF_NAME1 FROM HOSPITAL WHERE OFF_ID=HOS_IN_CARD) RFNAME FROM
 IPDTRANS I
            ...
            <table id="ptdetail_a" class="display dataTable" style="width:100%; font-family:K2D;font-size:16px; ">
                <thead>
                    <tr>
                        ...
                        <th>
                            <center>ประเภท Refer</center>
                        </th>
                        <th>
                            <center>รพ.ปลายทาง</center>
                        </th>
                        <th>
            ...
            <tr>
                ...
                <td>
                        ...
                        <td style="text-align:right;">
                            <?php echo  number_format($rs['M_TOTAL'], 2, ".", "," );?>
                        </td>
                    </tr>
                    <?php
            }
