...
$idcard=$rsd['idcard'];
$perto=$rsd['perto'];
$perremark=$rsd['perremark'];
$perfremark=$rsd['perfremark'];
?>
...
<form class="form-horizontal" action="sys_hycall_center_view.php" method=POST target="">
    ...
    <div class="form-group">
        <label for="name" class="control-label col-lg-3">เหตุผลในการรับงาน :</label>
        <div class="col-lg-6">
            <input class="form-control" type="text" name="hassrem" value="<?php echo $perremark;?>">
        </div>
    </div>
    <div class="form-group">
        <label for="name" class="control-label col-lg-3">เหตุผลในการปิดงาน :</label>
        <div class="col-lg-6">
            <input class="form-control" type="text" name="hassrem" value="<?php echo $perfremark;?>">
        </div>
    </div>
