...
if($hcode=='10682' || $hcode =='24005' || $hcode == '24006' || $hcode =='99773' || $hcode =='77491') {
    ...
    SELECT DOC_CODE,NAME,PRENAME,SURNAME
        FROM doc_dbfs
    WHERE PRENAME IN ('ผศ.พญ.','ผศ.นพ','รศ.นพ','ผศ.นพ.','รศ.นพ.','พญ.','พญ','ดร.พญ.','นพ','นพ.','น.พ.','ทพ.','ทพ','ท.พ.') AND  DOC_CODE <>'ADMIN' AND 
        DEL_FLAG IS NULL";
...
require_once('main_top_panel_head.php');
    require_once('main_top_menu_session_a.php');
?>
                ...
                <div class="panel-body" style="background-color:#90CAF9; color:black;">
                    ...
                    <div class="panel panel-warning">
                        <div class="panel-body" style="background:#64B5F6; color:#24135F;">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="pcr">ประเภทส่งต่อ (หน่วยงานต้นทาง)</label>
                                    <select class="form-control select2" name="rfev" id="rfev">
                                        <option value="" selected readonly>(เลือกประเภทส่งต่อ)</option>
                                        <?php
                    ...
                    <div class="panel panel-warning">
                        <div class="panel-body" style="background:#64B5F6; color:#24135F;">
                            ...
                            <div class="row">
                                <div class="form-group  col-sm-6">
                                    <div class="row" style="padding:1px 10px 0px 6px;">
                                        <h4><b>ประวัติผู้ป่วย</b></h4>
                                        <textarea class="form-control" name="his_patient" id='his_patient' rows="12"
                                            style="font-family:K2D;color:#000000; font-size:18px;font-weight:bold;">
                                        </textarea>
                                    </div>
                                    <div class="row" style="padding:1px 10px 0px 4px;">
                                        <h4><b>บันทึกการผ่าตัด</b></h4>
                                        <textarea class="form-control" name="his_oper" id='his_oper' rows="7"
                                            style="font-family:K2D;color:#000000; font-size:18px;font-weight:bold;">
                                        </textarea>
                                    </div>
                                    <div class="row" style="padding:1px 10px 4px 4px;">
                                        <h4><b>ตรวจร่างกาย</b></h4>
                                        <textarea class="form-control" name="his_body" id='his_body' rows="7"
                                            style="font-family:K2D;color:#000000; font-size:18px;font-weight:bold;">
                                        </textarea>
                                    </div>
                                </div>
                    ...
                    <div class="panel panel-warning">
                        <div class="panel-body" style="background:#64B5F6; color:#24135F;">
                            <div class="row" style="padding:1px 4px 4px;">
                                <div class="form-group col-sm-6"
                                    style="background-color:#004D40;color:#A7FFEB;padding:1px 15px 10px 6px;">
                                    <div class="card">
        ...
        $("#fhn").on('change', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var his_oper = data[0].his_oper;
                    var passport = data[0].passport;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data == '1') {
                        ...
                        swal({
                                title: "การบันทึกขัอมูล",
                                text: "บันทึกรายการ ไม่สำเร็จ โปรดตรวจสอบรายการก่อนทำการบันทึก อีกครั้ง ..!",
                                icon: "error",
                                timer: 3000,
                                buttons:false
                        })
                        ...
                        swal({
                            title: "การบันทึกขัอมูล",
                            text: "บันทึกรายการให้เรียบร้อยแล้ว ..!",
                            icon: "success",
                            timer: 3000,
                            buttons:false
                        })
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align:center;background:#901f3d;font-size:22px;font-weight:bold;color:#f6f0f7;  height:auto;"> 
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h3 class="modal-title">WARNING!!  Updated 20-05-2567 </h3>
                </div>
                <div class="modal-body" style="font-size:20px;font-weight:bold; text-align:center;color:#bb3030;"> 
                    <br>
                    <br>
                    <br>
                    1. ห้ามใส่อักขระในช่องรายการ ได้แก่ ('') (') <BR>
                    2. กรณีส่งต่อผู้ป่วยนอก ถ้าเรียกข้อมูลไม่ขึ้น กรุณาติดต่อห้องบัตร เพื่อคลิ๊กสิทธิบัตรหลัก <br> <br> <br>
                    *** โปรดทำการตรวจสอบ ***
                      <br><br><br>
                    <br>
                </div>
