...
<body>
    ...
    ?>
    <div class="box" style="border:5px solid #FBE9E7;font-family:K2D;font-size:18px;margin-top:0px;">
        <div class="tab">
            <ul class="nav nav-tabs">
                ...
                <li>
                    <a href="#tab3primary" class="nav-item nav-link" id="nav-home-tab" data-toggle="tab" role="tab"
                        aria-controls="nav-home" aria-selected="true">Approved Success
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="panel-body">
            <div class="tab-content">
                <div class="tab-pane fade in active" id="tab1primary">
                    <?php include("sys_hycall_hospital_ref_a.php");?>
                </div>
                <div class="tab-pane fade" id="tab2primary">
                    <?php include("sys_hycall_hospital_ref_b.php");?>
                </div>
                <div class="tab-pane fade" id="tab3primary">
                    <?php include("sys_hycall_hospital_ref_c.php");?>
                </div>
            </div>
        </div>
