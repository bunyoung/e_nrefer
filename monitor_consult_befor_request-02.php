...
if ($result_comment) {
    ...
    // Call Line notify
    $sql ="SELECT * FROM v_consult_detail WHERE cons_id='$consid' ";
    ...
    if(mysqli_num_rows($result) > 0) {
        while($row1 = mysqli_fetch_assoc($result)) 
        {
            ...
            $token = $line; 
            $str="มีการร้องของ Consult \n";
            $str.="........................................... \n";                       
            $str.="เลขที่ใบ Consult :".$row1['mcode'].'-'.$row1['cons_id']."\n";
            $str.="ความเร่งด่วน  :".$row1['e_fast']." \n";              
            $str.="วันที่ : ".$row1['rec_date'].'  เวลา :'.$row1['rec_time']."\n";
            $str.= "HN: ".$row1['hn'].'  '.$row1['pname']."\n";
            $str.= "Ward: ".$row1['fullplace']."\n";
            $str.= "Bed : ".$row1['beds']."\n";
            $str.= "จุดประสงค์ปรึกษา : ".$row1['exp']."\n";
            $str.= "ชื่อแพทย์ผู้ปรึกษา : ".$row1['namea'].'  '.$row1['surnamea']."\n";
            $str.= "Ward staff : ".$row1['nameb'].'  '.$row1['surnameb']."\n";
            $str.= "กลุ่มงาน : ".$row1['conmdepname'].";
                ...
                <table id="vfdataTable" class="table table-sm table-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr id="monitor">
                            ...
                            <td><?php echo $arr['mcode'].'-'.$arr['cons_id'];?></td>
