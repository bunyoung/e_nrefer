...
<body onLoad="window.print();">
    <div class="row">
        <div class="row text-center">
            <div class="col-md-12 font18b">ใบปรึกษาผู้ป่วยระหว่างแผนก (ใบ Consult)</div>
        </div>
        <hr>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12 font16t pt-0 pb-0"><?php echo 'จุดประสงค์ในการปรึกษาครั้งนี้ : '.$rs['exp'];?></div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12 font16t pt-0 pb-0">
                <?php echo 'ชื่อ-สกุลแพทย์ผู้ปรึกษา : '.$rs['preb'].''.$rs['nameb'].' '.$rs['surnameb'];?> ชื่อ-สกุลอาจารย์แพทย์ผู้รับผิดชอบ :
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 font16t pt-0 pb-0">
