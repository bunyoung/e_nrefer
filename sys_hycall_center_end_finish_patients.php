...
$fpplace=$rsd['toplace'];         // รหัสหน่วยร้องขอ
$tpplace=$rsd['fromplace'];       // รหัสหน่วยส่ง  ++++++

$fnplace=$rsd['fplace'];          // ชื่อหน่วยร้องขอ
$tnplace=$rsd['tplace'];          // ชื่อหน่วยส่ง
$hdate = $d_default;
...
<form class="form-horizontal" action="sys_hycall_db_return.php" method="POST" target="">
    <div class="panel panel-info">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2">
                <input type="text" class="form-control" name="hn" id="hn" autocomplete="off" value="<?php echo $hn; ?>"
                    required readonly>
            </div>
            <label for="shn" class="control-label col-lg-2">ชื่อ-สกุล:</label>
            <div class="col-lg-5">
                <input type="text" class="form-control" id="nname" autocomplete="off" value="<?php echo $na; ?>"
                    disabled>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <select class="form-control input-sm select2" name="hyass" id="sel_hyass">
        ...
        <!-- <div class="form-group">
            ...
            <div class="col-lg-5">
                <select class="form-control input-sm select2" name="fast" id="sel_fast">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <select class="form-control input-sm select2" name="fast" id="sel_fast">
                    <option value=""><?php echo $fast_name; ?></option>
                    <?php
                     while($rows=mysqli_fetch_array($SQLfast))
                     {
                     ?>
                    <option value="<?php echo $rows['fasts_id'];?>">
                        <?php echo $rows['fasts_id'].' '.$rows['fasts_name'];?>
                    </option>
                    <?php
                     }
                     ?>
        ...
        <!-- อุปกรณ์ -->
        <div class="form-group">
            <label for="aidhass" class="col-lg-2 col-form-label" align="right">อุปกรณ์ :</label>
            <div class="col-lg-5">
                <select class="form-control input-sm select2" name="hassa">
        ...
        <!-- อุปกรณ์เพิ่มเติม -->
        <div class="form-group">
            <label for="bidhass" class="col-lg-2 col-form-label" align="right">อุปกรณ์เพิ่มเติม :</label>
            <div class="col-lg-5">
                <select class="form-control input-sm select2" name="hassb">
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="item" value="<?php echo $hyitem; ?>" />
