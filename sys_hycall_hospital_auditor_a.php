...
$sql = "
SELECT *
FROM v_hossend_to_audit
WHERE rf_no_refer='$rid' ";
        ...
        <div class="table" style="width:100%;font-family: 'K2D';font: weight 100px;">
            <div class="card border-info"
                ...
                <div class="panel-heading"
                    style="background-color:#311B92;  color:#F4ECF7;font-size: 18px;font-weight:30;">
                    <span class="glyphicon glyphicon-send"></span>
                    Audit การส่งคนไข้เพื่อการรรักษาต่อ (e-Refer)
                </div>
                <div class="panel-body"
                    style="background-color:#5c55b7;  color:#F4ECF7;font-size: 18px;font-weight:30;">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-sm-12"> RF.NO: <a class="text text-"
                                        style="font-size:18px;font-weight:80px;color:#18FFFF"><?=$rfno; ?></a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">สถานพยาบาลต้นทาง :<a class="text text-"
                                        style="font-size:18px;font-weight:80px;color:#18FFFF">
                                        <?php echo $rsshp;?></a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">โรค/ภาวะ refer out :<a class="text text-"
                                        style="font-size:18px;font-weight:80px;color:#18FFFF">
                                        <?php echo $rfind;?> </a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-sm-12">วันที่:<a class="text text-"
                                        style="font-size:18px;font-weight:80px;color:#18FFFF">
                                        <?php echo $rfdate.'   เวลา :'.$rft.'  น.';?></a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">สถานพยาบาลปลายทาง :<a class="text text-"
                                        style="font-size:18px;font-weight:80px;color:#18FFFF">
                                        <?php echo $rssst;?></a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">กลุ่มงาน-สาขา :<a class="text text-"
                                        style="font-size:18px;font-weight:80px;color:#18FFFF">
                                        <?php echo  $rfm;?></a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-sm-12">ชื่อ-สกุล :<a class="text text-"
                                        style="font-size:18px;font-weight:80px;color:#18FFFF">
                                        <?php echo  $rfpt.' HN :'.$rfhn;?></a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">อายุ: <a class="text text-"
                                        style="font-size:18px;font-weight:80px;color:#18FFFF">
                                        <?php echo $rfage;?></a> ปี
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">เพศ: <a class="text text-"
                                        style="font-size:18px;font-weight:80px;color:#18FFFF">
                                        <?php echo $rfsex;?></a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-sm-12">สิทธิ์การรักษา :<a class="text text-"
                                        style="font-size:18px;font-weight:80px;color:#18FFFF">
                                        <?php echo $rfptname;?></a>
                                </div>
                            </div>
            ...
            <form action="insert_regis_sendto_hos.php" method=POST target="">
                <div class="panel-body" style="background:#365a9b; color:#F4ECF7;font-size: 18px;font-weight:30;">
                    <div class="row">
                        <div class="col-sm-1">
                            <label for="newa">V/S</label>
                        </div>
                        <div class="col-sm-1">
                            <label for="newa">BT<sup> ('C)</sup></label>
                            <input type="number" class="form-control col-sm-1" name="bt" id="bt">
                        </div>
                        <div class="col-sm-1">
                            <label for="oth">BP <sup>(mmHg)</sup> </label>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-10">
                                    <a href="https://www.google.co.th/maps/" target='_blank'>
                                        <img src='./img/gmap.png' atl="" style="width:40px; height:30px;"> Google
                                        Map </a>
                                </div>
                            </div>
                        </div>
