...
<table id="dataTablea">
    ...
    <tbody>
        ...
        <tr id="<?php echo $rfno; ?>" style="<?php echo $bc; ?>">
            ...
            <td>
                <div class="dropdown">
                    <button class="btn btn-" style="width:95%;background-color:#07272D;color:#E8EAF6" type="button"
            ...
            <td style="width:100px;">
                <center>
                    <?php
                                if(empty($rs['rf_no_thairefer']) || empty($rs['rf_ptype_expire']) || empty($rs['rf_place_money']) || empty($rs['rf_pttype'])){
                                    ?>
                    <a class="btn btn-danger" href="sys_hycall_center_now_edit.php?id=<?php echo $rs['rf_id'];?>"
                        style="font-family:'K2D';font-size:16px;"></i> Edit/Audit
                    </a>
                    <?php 
                                }else{
                                    ?>
                    <a class="btn btn-success" href="sys_hycall_center_now_edit.php?id=<?php echo $rs['rf_id'];?>"
                        style="font-family:'K2D';font-size:16px;"></i> Edit/Audit
                    </a>
                    <?php
                                }
