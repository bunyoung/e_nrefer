...
if(!isset($_SESSION)) {  
 ...
 $hcode=$_SESSION['10682'];
 $hname=$_SESSION["โรงพยาบาลหาดใหญ่"];
...
?>
    ...
    <div class="justify-content-md-center" style="margin-top:0px;margin: 2px 80px 2px;padding: 2px 2px 2px;">
                ...
                <div class="panel-body" style="background-color:#547980; color:#00dffc;">
                    ...
                    <div class="panel panel-warning">
                        <div class="panel-body" style="background:#c5e0dc; opacity: 1;
                            ...
                            <div class="row">
                                <div class="form-group col-sm-3">
                                    <label for="lpcr">แพ้ยา (มี/ไม่มี)</label>
