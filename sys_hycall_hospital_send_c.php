...
<div class="container-fluid" style="margin: 2px 2px 2px;padding: 2px 2px 2px;color:black;">
        <div class="commenta justify-content-md-center">
            <table id="dataTable-u" class="display dataTable" role="grid" style="width:100%;box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px; 
                           overflow-x: scroll; overflow-y: scroll;  white-space: word-wrap: break-word;"
                cellspacing="0">
                <thead  style="font-family: sarabun;font-size:normal;margin-top:0px;background-color:#472183;color:#F1F8E9">
                    <tr align="center">
                        <td>ลำดับ</td>
                        <?php
                            if($did==null) 
                        ...
                        <td>รพ. ปลายทาง</td>
                        <td style="width:10%">แพทย์<br>ผู้ส่งต่อ</td>
                ...
                * 
                FROM v_rf_detail 
                WHERE hosp_recive_rem='1'  AND rf_hospital = '$hcode'  AND  end_refer_end='N' AND rf_status='5' Order by rf_id DESC";
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td style="width:10%;"><?php echo $rs['docsend_prename'].''.$rs['docsend_name'].'  '.$rs['docsend_surname']; ?>
