...
PRENAME IN ('พญ','พญ.','ดร.พญ.','นพ','นพ.','น.พ.') AND DOC_CODE <>'ADMIN' AND DEL_FLAG IS null";
	...
	while($objResult = oci_fetch_array($objParse,OCI_BOTH))
       {
        ...
        // $name =  iconv("tis-620","utf-8",$objResult["DOC_CODE"].' - '.$objResult['PRENAME'].''.$objResult['NAME'].' '.$objResult['SURNAME']);
        // ป้องกันเครื่องหมาย '  
